...
## llamasage-contracts API

### Class: Client

The main client interface for interacting with the llamasage-contracts library.
...
def process(self, query, options=None):
    """
    Process a query using the llamasage-contracts engine.
